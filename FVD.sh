...
tmux send-keys "cd /home/triage/georgia_dtc_ops_team_chiron_mrsd/vlm_geolocator" Enter
sleep 1
tmux send-keys "export ROS_DOMAIN_ID=100 && source /opt/ros/humble/setup.bash && source /home/triage/georgia_dtc_ops_team_chiron_mrsd/airstack/ros_ws/install/setup.bash && python3 src/video_merger_node.py" Enter
...
tmux send-keys "cd /home/triage/georgia_dtc_ops_team_chiron_mrsd/vlm_geolocator" Enter
sleep 1
# tmux send-keys "export ROS_DOMAIN_ID=100 && source /opt/ros/humble/setup.bash && source /home/triage/georgia_dtc_ops_team_chiron_mrsd/airstack/ros_ws/install/setup.bash && python3 src/casualty_email_notifier.py" Enter
